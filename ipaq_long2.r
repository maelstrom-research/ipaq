...
#--MOD
ipaq_mult(dt_,output = 'PA_CYCLING_PARTIAL_MET_FLOOR',vars = c('PA_MOD_FREQ_EST_FLOOR','PA_MOD_TIME_DAY_EST_FLOOR_CLEAN','PA_CYCLING_PROP'),num = 6)
ipaq_mult(dt_,output = 'PA_GARDEN_VIG_PARTIAL_MET_FLOOR',vars = c('PA_MOD_FREQ_EST_FLOOR','PA_MOD_TIME_DAY_EST_FLOOR_CLEAN','PA_GARDEN_VIG_PROP'),num = 5.5)
ipaq_mult(dt_,output = 'PA_INSIDE_MOD_PARTIAL_MET_FLOOR',vars = c('PA_MOD_FREQ_EST_FLOOR','PA_MOD_TIME_DAY_EST_FLOOR_CLEAN','PA_INSIDE_MOD_PROP'),num = 3)
ipaq_mult(dt_,output = 'PA_GARDEN_MOD_PARTIAL_MET_FLOOR',vars = c('PA_MOD_FREQ_EST_FLOOR','PA_MOD_TIME_DAY_EST_FLOOR_CLEAN','PA_GARDEN_MOD_PROP'),num = 4)
ipaq_mult(dt_,output = 'PA_LEISURE_MOD_PARTIAL_MET_FLOOR',vars = c('PA_MOD_FREQ_EST_FLOOR','PA_MOD_TIME_DAY_EST_FLOOR_CLEAN','PA_LEISURE_MOD_PROP'),num = 4)
ipaq_mult(dt_,output = 'PA_WRK_MOD_PARTIAL_MET_FLOOR',vars = c('PA_MOD_FREQ_EST_FLOOR','PA_MOD_TIME_DAY_EST_FLOOR_CLEAN','PA_WRK_MOD_PROP'),num = 4)
