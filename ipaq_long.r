...
#--MOD
ipaq_mult(dt_,output = 'PA_CYCLING_PARTIAL_MET',vars = c('PA_MOD_FREQ_EST','PA_MOD_TIME_DAY_EST_CLEAN','PA_CYCLING_PROP'),num = 6*0.9)
ipaq_mult(dt_,output = 'PA_GARDEN_VIG_PARTIAL_MET',vars = c('PA_MOD_FREQ_EST','PA_MOD_TIME_DAY_EST_CLEAN','PA_GARDEN_VIG_PROP'),num = 5.5*0.9)
ipaq_mult(dt_,output = 'PA_INSIDE_MOD_PARTIAL_MET',vars = c('PA_MOD_FREQ_EST','PA_MOD_TIME_DAY_EST_CLEAN','PA_INSIDE_MOD_PROP'),num = 3*0.9)
ipaq_mult(dt_,output = 'PA_GARDEN_MOD_PARTIAL_MET',vars = c('PA_MOD_FREQ_EST','PA_MOD_TIME_DAY_EST_CLEAN','PA_GARDEN_MOD_PROP'),num = 4*0.9)
ipaq_mult(dt_,output = 'PA_LEISURE_MOD_PARTIAL_MET',vars = c('PA_MOD_FREQ_EST','PA_MOD_TIME_DAY_EST_CLEAN','PA_LEISURE_MOD_PROP'),num = 4*0.9)
ipaq_mult(dt_,output = 'PA_WRK_MOD_PARTIAL_MET',vars = c('PA_MOD_FREQ_EST','PA_MOD_TIME_DAY_EST_CLEAN','PA_WRK_MOD_PROP'),num = 4*0.9)
